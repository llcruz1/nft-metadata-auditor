...
var require_delayed_stream = __commonJS({
    "../node_modules/delayed-stream/lib/delayed_stream.js": function(exports, module2) {
        var DelayedStream = function DelayedStream() {
            this.source = null;
            this.dataSize = 0;
...
var require_combined_stream = __commonJS({
    "../node_modules/combined-stream/lib/combined_stream.js": function(exports, module2) {
        var CombinedStream = function CombinedStream() {
            this.writable = false;
            this.readable = true;
            this.dataSize = 0;
        ...
        CombinedStream.prototype.append = function(stream3) {
            ...
            if (isStreamLike) {
                if (!_instanceof(stream3, DelayedStream)) {
...
var require_db = __commonJS({
    "../node_modules/mime-db/db.json": function(exports, module2) {
        module2.exports = {
...
var require_mime_db = __commonJS({
    "../node_modules/mime-db/index.js": function(exports, module2) {
        module2.exports = require_db();
    }
});
// ../node_modules/mime-types/index.js
var require_mime_types = __commonJS({
    "../node_modules/mime-types/index.js": function(exports) {
        "use strict";
        var charset = function charset(type) {
        ...
        var contentType = function contentType(str) {
        ...
        var extension = function extension(type) {
            if (!type || typeof type !== "string") {
                return false;
            }
            var match = EXTRACT_TYPE_REGEXP.exec(type);
        ...
        var lookup = function lookup(path) {
        ...
        var populateMaps = function populateMaps(extensions, types) {
            var preference = [
                "nginx",
                "apache",
                void 0,
...
var require_defer = __commonJS({
    "../node_modules/asynckit/lib/defer.js": function(exports, module2) {
...
var require_async = __commonJS({
    "../node_modules/asynckit/lib/async.js": function(exports, module2) {
...
var require_abort = __commonJS({
    "../node_modules/asynckit/lib/abort.js": function(exports, module2) {
        var abort = function abort(state) {
            Object.keys(state.jobs).forEach(clean.bind(state));
            state.jobs = {};
        };
        var clean = function clean(key) {
...
var require_iterate = __commonJS({
    "../node_modules/asynckit/lib/iterate.js": function(exports, module2) {
        var iterate = function iterate(list, iterator, state, callback) {
        ...
        var runJob = function runJob(iterator, key, item, callback) {
            var aborter;
...
var require_state = __commonJS({
    "../node_modules/asynckit/lib/state.js": function(exports, module2) {
        var state = function state(list, sortMethod) {
...
var require_terminator = __commonJS({
    "../node_modules/asynckit/lib/terminator.js": function(exports, module2) {
        var terminator = function terminator(callback) {
...
var require_parallel = __commonJS({
    "../node_modules/asynckit/parallel.js": function(exports, module2) {
        var parallel = function parallel(list, iterator, callback) {
...
var require_serialOrdered = __commonJS({
    "../node_modules/asynckit/serialOrdered.js": function(exports, module2) {
        var serialOrdered = function serialOrdered(list, iterator, sortMethod, callback) {
...
var require_serial = __commonJS({
    "../node_modules/asynckit/serial.js": function(exports, module2) {
        var serial = function serial(list, iterator, callback) {
...
var require_asynckit = __commonJS({
    "../node_modules/asynckit/index.js": function(exports, module2) {
        module2.exports = {
...
var require_populate = __commonJS({
    "../node_modules/form-data/lib/populate.js": function(exports, module2) {
...
var require_form_data = __commonJS({
    "../node_modules/form-data/lib/form_data.js": function(exports, module2) {
        ...
        FormData4.prototype._trackLength = function(header, value, options) {
            ...
            if (!value || !value.path && !(value.readable && value.hasOwnProperty("httpVersion")) && !_instanceof(value, Stream)) {
                return;
            }
            ...
            for(var i = 0, len = this._streams.length; i < len; i++){
                if (typeof this._streams[i] !== "function") {
                    ...
                    if (typeof this._streams[i] !== "string" || this._streams[i].substring(2, boundary.length + 2) !== boundary) {
                        dataBuffer = Buffer.concat([
                            dataBuffer,
                            Buffer.from(FormData4.LINE_BREAK)
                        ]);
                    }
                }
            }
        ...
        FormData4.prototype.submit = function(params, cb) {
            ...
            this.getLength((function(err, length) {
                ...
                if (cb) {
                    var onResponse;
                    var callback = function callback1(error, responce) {
...
var require_proxy_from_env = __commonJS({
    "../node_modules/proxy-from-env/index.js": function(exports) {
        "use strict";
        var getProxyForUrl2 = function getProxyForUrl2(url2) {
        ...
        var shouldProxy = function shouldProxy(hostname, port) {
...
var require_ms = __commonJS({
    "../node_modules/ms/index.js": function(exports, module2) {
        ...
        var plural = function plural(ms, msAbs, n, name) {
...
var require_common = __commonJS({
    "../node_modules/debug/src/common.js": function(exports, module2) {
        var setup = function setup(env) {
            ...
            function disable() {
                var namespaces = _toConsumableArray(createDebug.names.map(toNamespace)).concat(_toConsumableArray(createDebug.skips.map(toNamespace).map(function(namespace) {
                    return "-" + namespace;
                }))).join(",");
                createDebug.enable("");
                return namespaces;
...
var require_supports_color = __commonJS({
    "../node_modules/supports-color/index.js": function(exports, module2) {
        "use strict";
        var translateLevel = function translateLevel(level) {
            if (level === 0) {
                return false;
            }
            return {
        ...
        var supportsColor = function supportsColor(stream3) {
            if (forceColor === false) {
                return 0;
            }
        ...
        var getSupportLevel = function getSupportLevel(stream3) {
...
var require_node = __commonJS({
    "../node_modules/debug/src/node.js": function(exports, module2) {
        ...
        var log = function log() {
            ...
            var _util;
            return process.stderr.write((_util = util).format.apply(_util, _toConsumableArray(args)) + "\n");
        };
        var save = function save(namespaces) {
            if (namespaces) {
...
var require_debug = __commonJS({
    "../node_modules/follow-redirects/debug.js": function(exports, module2) {
        var debug;
...
var require_follow_redirects = __commonJS({
    "../node_modules/follow-redirects/index.js": function(exports, module2) {
        var RedirectableRequest = function RedirectableRequest(options, responseCallback) {
            Writable.call(this);
        ...
        var wrap = function wrap(protocols) {
            var exports2 = {
                maxRedirects: 21,
            ...
            Object.keys(protocols).forEach(function(scheme) {
                ...
                function request(input, options, callback) {
                    if (isString2(input)) {
                        ...
                        input = parsed;
                    } else if (URL2 && _instanceof(input, URL2)) {
        ...
        var urlToOptions = function urlToOptions(urlObject) {
            var options = {
        ...
        var removeMatchingHeaders = function removeMatchingHeaders(regex, headers) {
            var lastValue;
        ...
        var createErrorType = function createErrorType(code, message, baseClass) {
        ...
        var abortRequest = function abortRequest(request) {
            var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
            try {
        ...
        var isSubdomain = function isSubdomain(subdomain, domain) {
            assert(isString2(subdomain) && isString2(domain));
            var dot = subdomain.length - domain.length - 1;
            return dot > 0 && subdomain[dot] === "." && subdomain.endsWith(domain);
        };
        var isString2 = function isString2(value) {
            return typeof value === "string" || _instanceof(value, String);
        };
        var isFunction2 = function isFunction2(value) {
            return typeof value === "function";
        };
        var isBuffer2 = function isBuffer2(value) {
        ...
        RedirectableRequest.prototype.setTimeout = function(msecs, callback) {
            var destroyOnTimeout = function destroyOnTimeout(socket) {
                socket.setTimeout(msecs);
                socket.removeListener("timeout", socket.destroy);
                socket.addListener("timeout", socket.destroy);
            };
            var startTimer = function startTimer(socket) {
                if (self._timeout) {
...
// ../src/core/services/Web3/Web3ServiceWrapper.ts
var Web3ServiceWrapper_exports = {};
__export(Web3ServiceWrapper_exports, {
    Web3ServiceWrapper: function() {
        return Web3ServiceWrapper;
    },
    default: function() {
        return Web3ServiceWrapper_default;
    }
});
module.exports = __toCommonJS(Web3ServiceWrapper_exports);
// ../src/core/services/Web3/NftMetadataService.ts
var import_ethers = require("ethers");
// ../src/core/abi/erc721Abi.json
...
// ../src/core/abi/erc1155Abi.json
var erc1155Abi_default = [
    {
        anonymous: false,
        inputs: [
            {
...
var isFormData = function(thing) {
    ...
    return thing && (typeof FormData === "function" && _instanceof(thing, FormData) || toString.call(thing) === pattern || isFunction(thing.toString) && thing.toString() === pattern);
};
...
function toFormData(obj, formData, options) {
    ...
    var defaultVisitor = function defaultVisitor(value, key, path) {
        var arr = value;
        if (value && !path && typeof value === "object") {
            if (utils_default.endsWith(key, "{}")) {
                ...
                arr.forEach(function each(el, index) {
                    !utils_default.isUndefined(el) && formData.append(indexes === true ? renderKey([
                        key
    ...
    function build(value, path) {
        ...
        utils_default.forEach(value, function each(el, key) {
            var result = !utils_default.isUndefined(el) && visitor.call(formData, el, utils_default.isString(key) ? key.trim() : key, path, exposedHelpers);
            if (result === true) {
...
function buildURL(url2, params, options) {
    ...
    var serializerParams = utils_default.isURLSearchParams(params) ? params.toString() : new AxiosURLSearchParams_default(params, options).toString(_encode);
    if (serializerParams) {
...
function fromDataURI(uri, asBlob, options) {
    var _Blob = options && options.Blob || node_default.classes.Blob;
...
Object.assign(AxiosHeaders.prototype, {
    set: function set(header, valueOrRewrite, rewrite) {
        ...
        if (utils_default.isPlainObject(header)) {
            utils_default.forEach(header, function(_value, _header) {
    ...
    toJSON: function toJSON() {
        ...
        utils_default.forEach(Object.assign({}, this[$defaults] || null, this), function(value, header) {
...
var AxiosTransformStream = /*#__PURE__*/ function(_import_stream_default_Transform) {
    _inherits(AxiosTransformStream, _import_stream_default_Transform);
    ...
    function AxiosTransformStream(options) {
        ...
        var _speedometer = speedometer_default(internals.ticksRate * options.samplesCount, internals.timeWindow);
...
}(import_stream.default.Transform);
var AxiosTransformStream_default = AxiosTransformStream;
// ../node_modules/axios/lib/adapters/http.js
var import_events = __toESM(require("events"), 1);
var isBrotliSupported = utils_default.isFunction(import_zlib.default.createBrotliDecompress);
var _import_follow_redirects_default = import_follow_redirects.default, httpFollow = _import_follow_redirects_default.http, httpsFollow = _import_follow_redirects_default.https;
var isHttps = /https:?/;
var supportedProtocols = node_default.protocols.map(function(protocol) {
    return protocol + ":";
});
...
function setProxy(options, configProxy, location) {
    ...
    if (!proxy && proxy !== false) {
        var proxyUrl = (0, import_proxy_from_env.getProxyForUrl)(location);
        if (proxyUrl) {
...
function httpAdapter(config) {
    return new Promise(function dispatchHttpRequest(resolvePromise, rejectPromise) {
        ...
        var headers = AxiosHeaders_default.from(config.headers).normalize();
        ...
        var maxUploadRate = void 0;
        var maxDownloadRate = void 0;
        ...
        if (data && (onUploadProgress || maxUploadRate)) {
            if (!utils_default.isStream(data)) {
                data = import_stream2.default.Readable.from(data, {
                    objectMode: false
                });
            }
            data = import_stream2.default.pipeline([
                data,
        ...
        req = transport.request(options, function handleResponse(res) {
            ...
            if (onDownloadProgress) {
                ...
                var transformStream = new AxiosTransformStream_default({
            ...
            var offListeners = import_stream2.default.finished(responseStream, function() {
                offListeners();
                onFinished();
            });
            var response = {
            ...
            if (responseType === "stream") {
                ...
                responseStream.on("aborted", function handlerStreamAborted() {
                    ...
                    var _$err = new AxiosError_default("maxContentLength size of " + config.maxContentLength + " exceeded", AxiosError_default.ERR_BAD_RESPONSE, config, lastRequest);
                    responseStream.destroy(_$err);
                    reject(_$err);
                });
        ...
        if (config.timeout) {
            ...
            req.setTimeout(timeout, function handleRequestTimeout() {
                ...
                var transitional2 = config.transitional || transitional_default;
...
var isURLSameOrigin_default = node_default.isStandardBrowserEnv ? function standardBrowserEnv2() {
    var resolveURL = function resolveURL(url2) {
        var href = url2;
        if (msie) {
...
function xhrAdapter(config) {
    return new Promise(function dispatchXhrRequest(resolve, reject) {
        ...
        var requestHeaders = AxiosHeaders_default.from(config.headers).normalize();
        var responseType = config.responseType;
        var onCanceled;
        ...
        if (node_default.isStandardBrowserEnv) {
            var xsrfValue = (config.withCredentials || isURLSameOrigin_default(fullPath)) && config.xsrfCookieName && cookies_default.read(config.xsrfCookieName);
            if (xsrfValue) {
...
var adapters_default = {
    getAdapter: function(nameOrAdapter) {
        if (utils_default.isString(nameOrAdapter)) {
            var adapter = adapters[nameOrAdapter];
            if (!nameOrAdapter) {
                throw Error(utils_default.hasOwnProp(nameOrAdapter) ? "Adapter '".concat(nameOrAdapter, "' is not available in the build") : "Can not resolve adapter '".concat(nameOrAdapter, "'"));
            }
            return adapter;
        }
...
function dispatchRequest(config) {
    ...
    var adapter = config.adapter || defaults_default.adapter;
...
function mergeConfig(config1, config2) {
    ...
    var mergeDeepProperties = function mergeDeepProperties(prop) {
    ...
    var valueFromConfig2 = function valueFromConfig2(prop) {
        if (!utils_default.isUndefined(config2[prop])) {
            return getMergedValue(void 0, config2[prop]);
        }
    };
    var defaultToConfig2 = function defaultToConfig2(prop) {
        if (!utils_default.isUndefined(config2[prop])) {
            return getMergedValue(void 0, config2[prop]);
        } else if (!utils_default.isUndefined(config1[prop])) {
            return getMergedValue(void 0, config1[prop]);
    ...
    var mergeDirectKeys = function mergeDirectKeys(prop) {
        if (prop in config2) {
            return getMergedValue(config1[prop], config2[prop]);
    ...
    _createClass(Axios, [
        {
            ...
            value: function request(configOrUrl, config) {
                ...
                var defaultHeaders = config.headers && utils_default.merge(config.headers.common, config.headers[config.method]);
...
utils_default.forEach([
    ...
    var generateHTTPMethod = function generateHTTPMethod(isForm) {
...
var CancelToken = /*#__PURE__*/ function() {
    function CancelToken1(executor) {
        _classCallCheck(this, CancelToken1);
...
// ../src/core/services/Http/TokenUriService.ts
var TokenUriService = /*#__PURE__*/ function() {
    function TokenUriService() {
        _classCallCheck(this, TokenUriService);
    }
    _createClass(TokenUriService, [
        {
            key: "getMetadataFromTokenUri",
            value: function getMetadataFromTokenUri(tokenUri) {
                    ...
                    return __generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                return [
                                    4,
                                    axios_default2.get("http://localhost:5000/nft/metadata?tokenUri=".concat(tokenUri))
                                ];
                            case 1:
    ...
    return TokenUriService;
}();
var TokenUriService_default = new TokenUriService();
// ../src/core/services/Http/HttpServiceWrapper.ts
var HttpServiceWrapper = function HttpServiceWrapper() {
    _classCallCheck(this, HttpServiceWrapper);
    this.tokenUriService = TokenUriService_default;
};
var HttpServiceWrapper_default = new HttpServiceWrapper();
// ../src/core/services/Web3/NftMetadataService.ts
var NftMetadataService = /*#__PURE__*/ function() {
    function NftMetadataService(httpServices) {
        _classCallCheck(this, NftMetadataService);
        this.httpServiceWrapper = httpServices;
    }
    _createClass(NftMetadataService, [
        {
            key: "getNftMetadata",
            value: function getNftMetadata(contractAddress, tokenId) {
                var tokenStandard = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : void 0;
                var _this = this;
                return _asyncToGenerator(function() {
                    var error, error1;
                    return __generator(this, function(_state) {
                        switch(_state.label){
                            ...
                            case 2:
                                ...
                                return [
                                    4,
                                    _this.getErc721Metadata(contractAddress, tokenId)
                                ];
                            case 3:
                                return [
                                    2,
                            ...
                            case 4:
                                ...
                                return [
                                    4,
                                    _this.getErc1155Metadata(contractAddress, tokenId)
                                ];
                            case 5:
                                return [
                                    2,
                            ...
                            case 6:
                                if (!(tokenStandard === "ERC-721" /* ERC721 */ )) return [
                                    3,
                                    8
                                ];
                                return [
        ...
        {
            key: "getErc721Metadata",
            value: function getErc721Metadata(contractAddress, tokenId) {
                var _this = this;
                return _asyncToGenerator(function() {
                    var nftContract, name, symbol, tokenUri, tokenUriData, nftMetadata;
                    return __generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                nftContract = new import_ethers.ethers.Contract(contractAddress, erc721Abi_default, _this.signer);
                                return [
                                    4,
                                    nftContract.name()
                                ];
                            ...
                            case 3:
                                tokenUri = _state.sent();
                                return [
                                    4,
                                    _this.getTokenUriData(tokenUri)
                                ];
                            case 4:
                                tokenUriData = _state.sent();
                                nftMetadata = {
        ...
        {
            key: "getErc1155Metadata",
            value: function getErc1155Metadata(contractAddress, tokenId) {
                var _this = this;
                return _asyncToGenerator(function() {
                    var nftContract, multiTokenUri, tokenUri, tokenUriData, nftMetadata;
                    return __generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                nftContract = new import_ethers.ethers.Contract(contractAddress, erc1155Abi_default, _this.signer);
                                return [
                                    4,
                                    nftContract.uri(tokenId)
                                ];
                            case 1:
                                multiTokenUri = _state.sent();
                                tokenUri = multiTokenUri.replace("0x{id}", tokenId);
                                return [
                                    4,
                                    _this.getTokenUriData(tokenUri)
                                ];
        ...
        {
            key: "getTokenUriData",
            value: function getTokenUriData(tokenUri) {
                var _this = this;
                return _asyncToGenerator(function() {
                    var error, emptyUriResponse;
                    return __generator(this, function(_state) {
                        switch(_state.label){
                            case 0:
                                _state.trys.push([
                                ...
                                return [
                                    4,
                                    _this.httpServiceWrapper.tokenUriService.getMetadataFromTokenUri(tokenUri)
                                ];
                            case 1:
                                return [
                                    2,
...
var NftMetadataService_default = new NftMetadataService(HttpServiceWrapper_default);
// ../src/core/services/Web3/Web3ServiceWrapper.ts
var Web3ServiceWrapper = function Web3ServiceWrapper() {
    _classCallCheck(this, Web3ServiceWrapper);
    this.nftMetadataService = NftMetadataService_default;
};
var Web3ServiceWrapper_default = new Web3ServiceWrapper();
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
    Web3ServiceWrapper: Web3ServiceWrapper
}); /*!
 * mime-db
